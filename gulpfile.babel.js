...
// Aggregrated Task
gulp.task('build', ['clean','assets','copy-manifest', 'popup-js', 'popup-html', 'popup-css', 'event-js', 'content-js', 'content-css','newtab-html','newtab-css','newtab-js']);

gulp.task('watch', ['build'], () => {
    gulp.watch('assets/**/*', ['clean_assets','assets']);
    gulp.watch('popup/**/*', ['clean_popup','popup-html','popup-css','popup-js']);   
    gulp.watch('newtab/**/*', ['clean_newtab','newtab-html','newtab-css','newtab-js']);   
    ...
    gulp.watch('utils/**/*', ['clean_event','clean_content','clean_newtab','content-css','content-js','event-js','newtab-css','newtab-js']);
